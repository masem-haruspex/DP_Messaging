...
if [ $# -lt 1 ]; then
  ...
  echo "Package groups:"
  echo "  myapp      - Your application only (com.mm_mk.Messaging)"
...
# Configuration
BASE_URL="http://localhost:9003/actuator/loggers"
USERNAME="admin"
PASSWORD="admin123"
LOG_LEVEL=$1
GROUP=${2:-"all"}
...
declare -A PACKAGE_GROUPS=(
  ...
  ["all"]="com.mm_mk.Messaging org.springframework.security org.springframework.web org.springframework.boot org.springframework.transaction org.hibernate.SQL org.hibernate.type.descriptor.sql org.springframework.jdbc.core org.apache.tomcat org.apache.catalina org.springframework.amqp org.springframework.amqp.rabbit com.rabbitmq"
)
